        ...
        <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
          <Layout className='pt-16'>
            ...
            <div className='grid grid-cols-12 gap-24 gap-y-32 mt-4 mb-4 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
              <div className='col-span-12'>
                <FramerImage src={headimg} alt="Modern-Portfolio" className='w-full h-auto'
                priority
          ...
          <Layout className='mt-16'>
            <div className='grid grid-cols-2 gap-16'>
                    <FramerImage src={maclight} alt="Mac-Light" className='w-full h-auto overflow-hidden'
                    priority
                    initial={{y:150, opacity:0}}
                    whileInView={{y:0, opacity:1, transition:{duration:0.5}}}
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
                    />
                    <FramerImage src={macdark} alt="Mac-Dark" className='w-full h-auto'
                    priority
                    initial={{y:150, opacity:0}}
                    whileInView={{y:0, opacity:1, transition:{duration:0.5}}}
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
          ...
          <Layout className='mt-16'>
            <div className='grid grid-cols-2 gap-16'>
                    <FramerImage src={ipadlight} alt="iPad-Light" className='w-full h-auto overflow-hidden'
                    priority
                    initial={{y:150, opacity:0}}
                    whileInView={{y:0, opacity:1, transition:{duration:0.5}}}
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
                    />
                    <FramerImage src={ipaddark} alt="iPad-Dark" className='w-full h-auto'
                    priority
                    initial={{y:150, opacity:0}}
                    whileInView={{y:0, opacity:1, transition:{duration:0.5}}}
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
          ...
          <Layout className='py-16'>
            ...
            <div className='flex items-center justify-center w-full'>
              <Link href="/projects/firstportfoliowebsite">
                <FramerImage src={firstportfolio} alt="First-Portfolio-Website" className='w-full h-auto flex items-center'
                priority
                initial={{y:150, opacity:0}}
