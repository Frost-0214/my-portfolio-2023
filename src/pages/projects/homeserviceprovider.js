        ...
        <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
          <Layout className='pt-16'>
            ...
            <div className='grid grid-cols-12 gap-24 gap-y-32 mt-4 mb-4 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
              <div className='col-span-12'>
                <FramerImage src={headimg} alt="HSPA" className='w-full h-auto'
                priority
          ...
          <Layout className='pt-16'>
            <div className='grid grid-cols-3 mt-16'>
                <FramerImage src={home} alt="HSPA-Home" className='w-full h-auto'
                priority
                initial={{y:150, opacity:1}}
                whileInView={{y:0, opacity:1, transition:{duration:0.5}}}
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
                />
                <FramerImage src={search} alt="HSPA-Search" className='w-full h-auto'
                priority
                initial={{y:150, opacity:1}}
                whileInView={{y:0, opacity:1, transition:{duration:0.5}}}
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
                />
                <FramerImage src={profile} alt="HSPA-Profile" className='w-full h-auto'
                priority
                initial={{y:150, opacity:1}}
                whileInView={{y:0, opacity:1, transition:{duration:0.5}}}
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
          ...
          <div className='col-span-12 mt-16'>
                <Image src={hspa2} alt="HSPA" className='w-full h-auto'
                priority
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
                />
          </div>
          <Layout className='mt-16'>
            <div className='flex relative gap-24 gap-y-32 mt-4 mb-4 items-center justify-center'>
              <div className='flex relative items-center justify-center'>
                ...
                <Image src={ip14} alt="iPhone14" className='w-full h-auto'
                priority
          ...
          <div className='col-span-12 mt-16'>
            <Image src={hspaend} alt="Playstore" className='w-full h-auto'
            priority
            sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
            />
              <Link href="https://play.google.com/store/apps/details?id=com.hspa.capstone&pcampaignid=web_share" target='_blank'>
                <Image src={psimg} alt="PSButton" className='w-[42%] h-auto absolute ml-24 -mt-80 cursor-pointer xl:ml-16 xl:w-[43%] xl:-mt-60 lg:ml-16 lg:w-[41%] lg:-mt-52 md:ml-10 md:w-[44%] md:-mt-40 sm:ml-10 sm:w-[42%] sm:-mt-32 xs:ml-6 xs:w-[42%] xs:-mt-20'
                priority
                />
              </Link>
          </div>
          <Layout className='py-16'>
            ...
            <div className='flex items-center justify-center w-full'>
              <Link href="/projects/modernportfoliowebsite">
                <FramerImage src={modernportfolio} alt="Modern-Portfolio-Website" className='w-full h-auto flex items-center'
                priority
                initial={{y:150, opacity:0}}
